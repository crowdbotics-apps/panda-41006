"""
Django settings for panda_41006 project.
...
WSGI_APPLICATION = 'panda_41006.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "panda_41006 API",
    "DESCRIPTION": "API documentation for panda_41006 App",
    "VERSION": "v1",
}
